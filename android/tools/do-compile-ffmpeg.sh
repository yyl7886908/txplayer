...
ln -s $FF_PREFIX/libtxffmpeg.so $FF_PREFIX/shared/lib/libtxffmpeg.so
...
for f in $FF_PREFIX/lib/pkgconfig/*.pc; do
    ...
    mysedi $f 's/-lavcodec/-ltxffmpeg/g'
    mysedi $f 's/-lavformat/-ltxffmpeg/g'
    mysedi $f 's/-lavutil/-ltxffmpeg/g'
    mysedi $f 's/-lswresample/-ltxffmpeg/g'
    mysedi $f 's/-lswscale/-ltxffmpeg/g'
done
