...
{
    SDL_Vout_Opaque *opaque = vout->opaque;
    TXSDLGLView *gl_view = opaque->gl_view;
...
static void SDL_VoutIos_SetGLView_l(SDL_Vout *vout, TXSDLGLView *view)
{
    SDL_Vout_Opaque *opaque = vout->opaque;
...
void SDL_VoutIos_SetGLView(SDL_Vout *vout, TXSDLGLView *view)
{
    SDL_LockMutex(vout->mutex);
