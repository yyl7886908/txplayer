...
@implementation TXSDLAudioQueueController {
...
static void TXSDLAudioQueueOuptutCallback(void * inUserData, AudioQueueRef inAQ, AudioQueueBufferRef inBuffer) {
    @autoreleasepool {
        TXSDLAudioQueueController* aqController = (__bridge TXSDLAudioQueueController *) inUserData;
