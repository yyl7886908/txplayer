...
- (void)viewDidLoad
{
    ...
    NSURL *theMovieURL = [NSURL URLWithString:@"http://192.168.1.100:8080/video/test.ts"];
    
    [TXFFMoviePlayerController setLogReport:YES];
    self.player = [[TXFFMoviePlayerController alloc] initWithContentURL:theMovieURL withOptions:nil];
...
-(void)installMovieNotificationObservers
{
	[[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(loadStateDidChange:)
                                                 name:TXMoviePlayerLoadStateDidChangeNotification
                                               object:_player];
    
	[[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(moviePlayBackDidFinish:)
                                                 name:TXMoviePlayerPlaybackDidFinishNotification
                                               object:_player];
    
	[[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(mediaIsPreparedToPlayDidChange:)
                                                 name:TXMediaPlaybackIsPreparedToPlayDidChangeNotification
                                               object:_player];
    
	[[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(moviePlayBackStateDidChange:)
                                                 name:TXMoviePlayerPlaybackStateDidChangeNotification
                                               object:_player];
}
...
{
    [[NSNotificationCenter defaultCenter]removeObserver:self name:TXMoviePlayerLoadStateDidChangeNotification object:_player];
    [[NSNotificationCenter defaultCenter]removeObserver:self name:TXMoviePlayerPlaybackDidFinishNotification object:_player];
    [[NSNotificationCenter defaultCenter]removeObserver:self name:TXMediaPlaybackIsPreparedToPlayDidChangeNotification object:_player];
    [[NSNotificationCenter defaultCenter]removeObserver:self name:TXMoviePlayerPlaybackStateDidChangeNotification object:_player];
}
